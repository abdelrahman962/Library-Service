...
from .tools_redis import library_tools, set_api_client
load_dotenv()
...
def invoke_library_agent(user_input: str):
    """
    Run the agent and return a concise response.

    For now this simply wraps the normal agent.
    We will use it to implement optimized handling
